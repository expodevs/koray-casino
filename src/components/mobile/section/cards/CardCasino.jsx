...
export default function CardCasino() {
    ...
    return (
        <article className={`${styles['item-card']} ${styles.casino}`}>
            ...
            <div className={styles.name}><span>Up to $2,500 and 200 Free Spins</span></div>

            <div className={styles['list-options']}>
                <div className={styles['item-option']}>
                    <div className={styles['label-option']}>
                        <div className={styles['name-option']}>Win rate</div>
                    </div>
                ...
                <div className={styles['item-option']}>
                    <div className={styles['label-option']}>
                        <div className={styles['name-option']}>Payout</div>
                    </div>
                    <div className={styles['label-value']}>
                        <span>1-2 days</span>
                    </div>
