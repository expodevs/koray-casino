...
export default function EntityList() {
    ...
    const handleDelete = async (id: number) => {
        ...
        try {
            const res = await fetch(routeAdminApiCasinoOptions.one(id.toString()), {
                method: 'DELETE',
            });
    ...
    return (
        <div className="p-6">
            ...
            <Link
                href={routeAdminPageCasinoOptions.create}
                        ...
                        {data.data.map((option) => (
                            <tr key={option.id} className="border-b hover:bg-gray-50">
                                ...
                                <td className="p-3 flex gap-2">
                                    <Link
                                        href={routeAdminPageCasinoOptions.edit(option.id.toString())}
