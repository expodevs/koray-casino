...
export default function CardList() {
    ...
    const handleDelete = async (id: number) => {
        ...
        try {
            const res = await fetch(routeAdminApiCards.oneCasino(id.toString()), {
                method: 'DELETE',
            });
    ...
    return (
        <div className="p-6">
            <div className="mb-4 flex justify-end items-center">
                <Link
                    href={routeAdminPageCards.createCasino}
                            ...
                            {data.data.map((card) => (
                                <tr key={card.id} className="border-b hover:bg-gray-50">
                                    ...
                                    <td className="p-3 flex gap-2">
                                        <Link
                                            href={routeAdminPageCards.editCasino(card.id.toString())}
