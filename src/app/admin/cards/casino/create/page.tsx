...
import CardForm from "@app/admin/cards/casino/components/CardForm";
...
export default function CreateCardPage() {
  ...
  const handleSubmit = async (data: unknown) => {
    try {
      const response = await fetch(routeAdminApiCards.allCasino, {
        method: 'POST',
      ...
      router.push(routeAdminPageCards.casino);
    } catch (error) {
